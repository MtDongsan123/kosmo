...
public class DataType {
	...
	public static void main(String[] args) {
		...
		byte bb;
		byte cc;
		//bb = 128;    // byte 범위를 넘겨서 입력 오류 bb = (byte)128;는 오류 안남
		bb = (byte)128; // -128
		cc = (byte)129; // -127 (byte)붙으면 -됨
		System.out.println("bb의 출력값 : " + bb);
		System.out.println("bb의 출력값 : " + cc);
		...
		long eee;
		eee = 1234567891L; //long 값을 넣을 땐 대문자나 소문자 L을 뒤에 붙여야한다.
