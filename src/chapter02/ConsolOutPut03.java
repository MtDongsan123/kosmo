...
public class ConsolOutPut03 {
	public static void main(String[] args) {
		...
		System.out.println("문자" + 1); // 문자13 , <연결>
		System.out.println("문자" + 1 + 3);
		System.out.println(1+3 + "문자"); //4문자
		System.out.println();
		int a = 5 ; //int는 자료형, =는 할당, 5는 변수, ==는같다 변수 앞에는 반드시 자료형이 앞에 있어야 함
		String b= "하세요"; //변수는 괜찮지만 문자열에는 따움표
		int c = 7 ;
		...
		System.out.printf("당신의 나이는 %d 이고, 오늘은 %s 이고, 당신의 %s입니다.",
				d, e, f);
		...
		System.out.println(i + "평균 나이가" + g +  "살이 될 것입니다. 평균적으로" + h + "에 많이 태어났습니다.");
