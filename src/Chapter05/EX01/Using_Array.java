...
public class Using_Array {
	...
	public static void main(String[] args) {
		// 기본 자료형인 경우 : RAM 에 Stack 영역에 변수와 값이 같이 저장이됨
		//참조 자료형인 경우 : RAM에 Stack 영역에 변수명이 저장이되고
		...
		// new : Heap 영역의 배열 방 5개를 생성해서 Heap영역의 번지를 a변수에 할당해라
		
		//배열 변수의 값을 할당
		a[0] = 10; // Heap 영역의 index 0 밤에 정수 10을 넣어라
		a[1] = 20; 
		a[2] = 30;
		a[3] = 40;
		a[4] = 50;
		...
		System.out.println("======for 문에서 a.langth를 사용해서 출력======");
