...
public class Using_Array04 {
	...
	public static void main(String[] args) {
		...
		//		- 참조 자료형 : 변수는 Stack에 저장, 값은 Heap 메모리에 저장
		...
		//입력
		for (int i = 0, j = 100 ; i < 5; i++, j+=100) { // i : index (0~4)
			a[i] = j;
		...
		//각방의 값을 입력
		for (int i = 0, j = 1000 ; i < a.length; i++, j+=100) { // i : index (0~4)
			a[i] = j;
