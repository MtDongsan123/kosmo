...
public class Using_Polymorphism01_2 {
	...
	public static void main(String[] args) {
		...
		//2. Person 객체 생성
			...
			//Animal 타입의 필드, 메서드만 접근 가능, Person타입으로 다운 캐스팅이 가능
		
		Animal a2 = new Person();
		System.out.println(a2.name);
		
		//a2 는 Person 타입으로 다운 캐스팅 (Animal, Person 필드, 메서드 모두 접근 가능)
		Person p1 = (Person) a2;
		System.out.println(p1.name);
		System.out.println(p1.personName);
		
		//3. Person 객체를 Person 타입으로 생성 (Animal, Person 필드, 메서드 모두 사용됨)
