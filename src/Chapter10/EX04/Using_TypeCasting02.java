...
class Bb extends Aa{		//자식 클래스 객체를 생성시 부모 클래스의 기본  생성자를 호출해서 부모 클래스가 먼저
								//생성후 자식 클래스가 생성됨.
	int b = 20;
	void b() {
...
public class Using_TypeCasting02 {
	...
	public static void main(String[] args) {
		...
		//1. Aa 객체를 Aa 타입으로 생성
			//aa1는 Aa타입만 내포, Aa를 타입으로 지정
			//aa1는 Aa의 필드나 메서드만 사용가능
		...
		Bb bb1 = new Bb();
			...
			// instance of 를 사용해서 오류가 발생하지 않도록 처리가 필요. <== 
				...
				if(bb1 instanceof Cc) {	//bb1 객체에 Cc타입을 내포하고 있을 때 True가 리턴
				Cc cc1 = (Cc) bb1;
				}else {
