...
//E 클래스는 A 클래스를 상속 받는다. <== A 클래스의 모든 필드와 메서드를 물려 받는다.
// A 클래스 : 부모 클래스 (super class) ,필드, 메서드
...
//		System.out.println(d); 	// private 	 <== 부모의 d 필드
		...
		print1();	//부모 클래스의 메서드 호출 public
		print2();	//부모 클래스의 메서드 호출 protected
		print3();	//부모 클래스의 메서드 호출 default
//		print4();	//부모 클래스의 메서드 호출 private
